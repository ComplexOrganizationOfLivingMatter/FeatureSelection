...
%   Developed by Pablo Vicente-Munuera
    ...
    for imK = 1:size(lee_matrices,1)
        if (lee_matrices(imK).isdir == 0)
            ...
            outputLEDAFileName = strcat('E:\Pablo\PhD-miscelanious\voronoiNetworks\results\graphletVectors\', inNameFile(1), '.gw')
            outputLEDAFileNameExists = strcat('E:\Pablo\PhD-miscelanious\voronoiNetworks\results\graphletVectors\', inNameFile(1), '.gw')
