...
mypaths = []
mypaths.append('/home/pablo/vboxshare/PhD-miscelanious/AgingDots/results/distanceMatrix/')
...
for mypath in mypaths:
	...
	for fileName in onlyfiles:
		...
		if os.path.isfile('/home/pablo/vboxshare/PhD-miscelanious/AgingDots/results/sortingAlgorithm/' + outputFileName[0] + 'It' + '1' + '.mat') == 0:
			start = time.time()
			...
			if len(distanceMatrix) > 15:
				...
				while True:
					...
					scipy.io.savemat('/home/pablo/vboxshare/PhD-miscelanious/AgingDots/results/sortingAlgorithm/sorting_' + outputFileName[0] + 'It' + str(iteration) + '.mat', mdict={'adjacencyMatrix': adjacencyMatrixOut})
